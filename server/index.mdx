...
1. [**Tool Basics**](/docs/server/basics) - Learn the fundamentals
2. [**Advanced Patterns**](/docs/server/advanced) - Complex business logic
3. [**API Integration**](/docs/server/integration) - Connect to external services
