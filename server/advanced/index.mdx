...
description: "Learn advanced patterns for building sophisticated FastApps tools."
---
...
- [**API Integration**](/docs/server/integration) - Connect to external APIs
- [**Back to Tool Basics**](/docs/server/basics)
- [**Back to Server Overview**](/docs/server)